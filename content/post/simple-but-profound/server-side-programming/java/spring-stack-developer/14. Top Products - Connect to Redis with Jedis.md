...
{{% figure src="../images/12/new_service_top_product.png" title="" alt="img" %}}
...
Replace the productInfo() method's original content with the following one in the ProductController.java file under the controller/src/main/java/co.dongchen.shop/controller directory:
