...
{{% figure src="../images/44/ll_file_chmod_g_file_ll_file_chmod_g_file_ll_file_chmod_g_file_ll_file.png" title="" alt="img" %}}
...
{{% figure src="../images/44/printf_c_code_file_cat_file.png" title="Print the C code into" alt="img" %}}
